/*
 * Source from			: https://github.com/nickdademo/cypress-fx3-sdk-linux/tree/master/util/cyusb_linux_1.0.4
...
static int
fx3_reoot_system(cyusb_handle  *h)

{
	int r = 0;
	r = cyusb_control_transfer (h, 0x40, 0xE0, 0, 0, NULL, 0, VENDORCMD_TIMEOUT);
		...
		char **argv)
{
	...
	if (((filename == NULL) || (tgt == FW_TARGET_NONE)) && (tgt != FW_REBOOT)) {
